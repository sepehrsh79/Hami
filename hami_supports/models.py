...
class Support (models.Model):
    ...
    price = models.IntegerField(verbose_name='مبلغ حمایت')
    project = models.ForeignKey(Project, on_delete=models.CASCADE, verbose_name='پروژه')
    supporter = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='حمایت کننده', blank=True, null=True, default='ناشناس' )
